...
# Tuned for print-quality coloring-book line art: clean black outlines,
# absolutely no shading or fill, subject isolated on a pure white background.
UNIVERSAL_POSITIVE = (
    "black and white coloring book page, clean crisp black outlines only, "
    "bold continuous contour lines, pure solid black line art on pure white background, "
...
UNIVERSAL_NEGATIVE = (
    "color, colour, colored, rgb, grey, gray, grayscale, greyscale, "
    "shading, shadow, shade, gradient, gradients, ombre, "
    "watercolor, pencil texture, charcoal, crosshatch, hatching, stippling, dithering, "
    "noise, grain, blur, blurry, jpeg artifacts, halftone, "
    "photo, photograph, photorealistic, realistic, 3d render, render, painting, "
    "sketchy, sketch marks, pencil marks, rough lines, broken lines, double lines, "
    "filled areas, solid black fill, black background, dark background, "
    "text, words, letters, caption, label, signature, watermark, logo, copyright, "
